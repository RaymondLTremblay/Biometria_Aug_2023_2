...
::: nota
**Error de tipo I (**$\alpha$): rechazar una hipótesis nula que en realidad es cierta (un *falso positivo*). **Error de tipo II (**$\beta$): no rechazar una hipótesis nula que en realidad es falsa (un *falso negativo*).
:::
...
**DONDE esta el error en la figura?**
