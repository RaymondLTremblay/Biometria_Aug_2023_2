...
Por consecuencia es **primordial** que cada investigador cumple con evaluar los supuestos de las pruebas que usa y si no cumple que busca métodos alternos.  Por ejemplo se puede utilizar métodos de análisis no paramétrica, también estadística bayesiana o robusta o como alternativas.  
...
Nota la formula para calcular la distribución normal (la densidad). Hay solamente dos parámetros que necesitamos, el promedio $\mu$ y la desviación estándar $\sigma$. Todos los otros son constantes, $\pi$, y  $\log_e$.  
