...
#### Evalúa cada uno y después abre MSTeam para contestar las preguntas
...
Los Datos: los datos muestran el número de "home runs" de la Liga Americana de béisbol en los últimos 30 años. Cada número es la cantidad máxima de home runs en uno de los años.
