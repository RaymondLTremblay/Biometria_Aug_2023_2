...
description: |
  Este libro digital es una introducción al estudio de la BioEstadística
link-citations: yes
...
::: {.banner-cover}
**Bienvenidos a BioEstadística.** Un curso práctico de estadística aplicada a la
biología con R, RStudio y RMarkdown: aprenderás a explorar datos, verificar
supuestos, elegir la prueba adecuada y **interpretar** correctamente tus
resultados para contestar preguntas biológicas.
:::
...
::: {.historia}
**R** es un lenguaje libre y de código abierto para estadística y gráficos. Fue creado a inicios de los años 1990 por **Ross Ihaka** y **Robert Gentleman** en la Universidad de Auckland (Nueva Zelanda), como una implementación libre del lenguaje **S** que **John Chambers** había desarrollado en los Bell Labs. Hoy lo mantiene una comunidad mundial de voluntarios.
:::
